...
First step is to fork this repository (rahulsain/birthdaygreet) to your GitHub account. You can do this by clicking on the Fork button provided in the top right corner of the repo page. 
...
Be careful to clone the forked repo (your-username/birthdaygreet) and not the main repo (rahulsain/birthdaygreet) as making direct changes to the main repo will result in conflict of code and lack of co-ordination as we proceed further.
...
So, after cloning the forked repository (your-username/birthdaygreet) to your system, use the command `git remote add upstream https://github.com/rahulsain/birthdaygreet.git` to point to the main repository. You only need to do this once.
